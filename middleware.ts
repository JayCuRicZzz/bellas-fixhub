...
const publicPaths = ['/login', '/api/auth/login', '/api/auth/logout', '/login/set-password', '/api/auth/set-password', '/api/setup', '/api/setup/clean-seed', '/api/cron/pm-check', '/api/cron/daily-summary', '/api/categories'];
